...
const Header = () => {
  return (
    <header className="sticky top-0 py-4 border border-red-500">
      <Section className="flex items-center justify-between">
        <h1 className="text-lg font-bold text-primary">myPortfolio.com</h1>

        <ul className="flex items-center gap-2  border border-yellow-500">
          <Link
